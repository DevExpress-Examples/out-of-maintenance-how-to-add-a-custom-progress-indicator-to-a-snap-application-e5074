...
Namespace CustomProgressIndicator
	Partial Public Class MyProgressIndicationForm
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(MyProgressIndicationForm))
			...
			Me.gaugeControl1.Controls.Add(Me.btnClose)
			...
			Me.gaugeControl1.Size = New System.Drawing.Size(284, 262)
			Me.gaugeControl1.TabIndex = 0
			Me.gaugeControl1.UseWaitCursor = True
			' 
			' btnClose
			' 
			...
			' linearGauge1
			' 
			Me.linearGauge1.Bounds = New System.Drawing.Rectangle(6, 6, 272, 250)
			...
			Me.labelComponent1.FormatString = "{0}%"
			Me.labelComponent1.Name = "linearGauge1_Label1"
			Me.labelComponent1.Position = New DevExpress.XtraGauges.Core.Base.PointF2D(65F, 125F)
			Me.labelComponent1.Size = New System.Drawing.SizeF(50F, 25F)
			Me.labelComponent1.Text = "100"
			...
			Me.Name = "MyProgressIndicationForm"
			Me.ShowIcon = False
			Me.ShowInTaskbar = False
			Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent
			Me.Text = "MyProgressIndicationForm"
